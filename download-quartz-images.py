#!/usr/bin/env python3
"""Download quartz slab images, save as images/quartz/{slug}.jpg, crop/resize to uniform square, update JSON."""
import json
import ssl
...
IMG_DIR = Path(__file__).parent.parent / "images" / "quartz"
SIZE = 400
...
def main():
    ...
    print(f"Downloaded/saved {ok} quartz images to {IMG_DIR} (uniform squares {SIZE}x{SIZE})")
    if err:
