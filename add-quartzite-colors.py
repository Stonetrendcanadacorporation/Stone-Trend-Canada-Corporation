#!/usr/bin/env python3
"""Add color and category metadata to Olympia quartzite slabs based on names."""
import json
import re
...
COLOR_RULES = [
    ...
    (r"\b(cream|crema|beige|tan|biscuit|cappucino|cappuccino)\b", "cream"),
...
def main():
    ...
    print(f"Updated {len(slabs)} quartzite slabs. Colors used: {sorted(all_colors)}")
