#!/usr/bin/env python3
"""Add color and category metadata to Olympia travertine slabs based on names."""
import json
import re
...
def get_category(name, colors):
    ...
    if colors_set == {"white"}:
        return "light"
    if colors_set <= {"white", "grey", "cream"}:
        return "light"
    return "multicolour"
...
def main():
    ...
    print("Updated", len(slabs), "travertine slabs. Colors used:", sorted(all_colors))
