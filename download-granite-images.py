#!/usr/bin/env python3
"""Download granite slab images, save as images/granite/{slug}.jpg, crop/resize to uniform square, update JSON."""
import json
import ssl
...
IMG_DIR = Path(__file__).parent.parent / "images" / "granite"
...
def main():
    ...
    print(f"Downloaded/saved {ok} granite images to {IMG_DIR} (uniform squares {SIZE}x{SIZE})")
    if err:
